...
//DEL void CMainFrame::OnButtoncalib() 
//DEL {
//DEL 	// TODO: Add your command handler code here
//DEL //	statetag = (statetag+1)%3;
//DEL //	char buff[20];
//DEL //	itoa(statetag,buff,10);
//DEL //	CString tmpStr("statetag:");
//DEL //	tmpStr = tmpStr+buff+" , m_bestAlph:";
//DEL //	CString bst;
//DEL ///	bst.Format("%f",m_bestAlph);
//DEL //	bst = tmpStr+bst;
//DEL //	MessageBox(bst);
//DEL 	statetag = 1;
//DEL 
...
//DEL void CMainFrame::OnCal2x2() 
//DEL {
//DEL 	// TODO: Add your command handler code here
//DEL     
//DEL 	CCaliDlg2X2 *pDlg = new CCaliDlg2X2;
//DEL 	pDlg->Create(IDD_CAL2X2,this);
//DEL 	pDlg->ShowWindow(SW_SHOW);
//DEL     statetag = 1;
//DEL 	char buff[20];
//DEL 	itoa(statetag,buff,10);
//DEL 	CString tmpStr("statetag:");
//DEL     tmpStr = tmpStr+buff;
//DEL //	MessageBox("OnCal2x2:"+tmpStr);
//DEL 
//DEL }
...
void CMainFrame::OnBtcalib() 
{
	...
	/*
	char buff[20];
	itoa(CPublic::stateTag,buff,10);
	CString tmpStr("CPublic::stateTag:");
    tmpStr = tmpStr+buff;*/
}
...
//DEL 	HCURSOR hCur  =  LoadCursor(NULL, IDC_NO);
//DEL                 ::SetCursor(hCur);
